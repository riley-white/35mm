 function App(){
	...
	this.displayList = [
		...
		new Picture(document.getElementById("img1"),30,150),
		new Picture(document.getElementById("img2"),950,500),
		new Picture(document.getElementById("img3"),590,70),
		new Picture(document.getElementById("img4"),1475,200),
		new Picture(document.getElementById("img5"),1000,50),
		new Picture(document.getElementById("text-box"),275,160),
		new Picture(document.getElementById("txt"),0,500),
